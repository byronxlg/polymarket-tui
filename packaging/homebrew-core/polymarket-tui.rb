class PolymarketTui < Formula
  ...
  resource "poly-eip712-structs" do
    url "https://files.pythonhosted.org/packages/39/18/9fc1be6ac78bff14f56b88dedd019b2a669a5ff570cc40f055dccef294fe/poly_eip712_structs-0.0.1.tar.gz"
    sha256 "d9193766fde497b1ee01c79a50092733a34b7a94bed090deb5d3c1b1e41f6d8c"
  end

  resource "py-builder-signing-sdk" do
    url "https://files.pythonhosted.org/packages/18/e3/fab3253021a4d766345f491f00e40d89c7c5640bf6d20d9f5a3182b482de/py_builder_signing_sdk-0.0.2.tar.gz"
    sha256 "27fa4401944220c51809f549a263c6e53b5cd981fca98eda7ef6f21944e6bf94"
  end

  resource "py-clob-client" do
    url "https://files.pythonhosted.org/packages/e4/4d/00896d81210ffae5b2e9b33b9d1e6b247d1b017c1ac98038d2a638a3ecc2/py_clob_client-0.34.6.tar.gz"
    sha256 "09c6b96e7296f6cc22466018af9ab74bcaab661a697432025e7257252c660af4"
  end

  resource "py-clob-client-v2" do
    url "https://files.pythonhosted.org/packages/53/de/7d5c9e02988a221c44ab2d74b4bd682810e3e3f3a4856be7eef2bc874f6e/py_clob_client_v2-1.0.2.tar.gz"
    sha256 "9c19a86a1ca67a995f3da4f2d95fd5d5e9e7e14777cb6fe4294b90040ccf67d0"
  end

  resource "py-order-utils" do
    url "https://files.pythonhosted.org/packages/5b/b8/9125d3960748f4f2d41f0e10ae42c29e60f6d3a37b8a758df7375346bf01/py_order_utils-0.3.2.tar.gz"
    sha256 "4c0ecb939f4ce0313cd8a4ca32f2ba9a72449a6fc9ee17b9ce1937f594662988"
  end
